...
document.addEventListener('DOMContentLoaded', () => {
   ...
   let number = 1;
   for (let i = 0; i < box_number.length; i++) {
      let className = box_number[i].className;

      if (box_number[i + 1] && className != box_number[i + 1].className) {
   ...
   //swiper
   let slider_single = new Swiper('.slider-single', {
      observer: true,
      observeParents: true,
      slidesPerView: 3,
      spaceBetween: 0,
      ...
      // Navigation arrows
      navigation: {
         nextEl: '.slider-single__next',
         prevEl: '.slider-single__prev',
      },
